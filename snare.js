...
var _i_cr = {
    ...
    _i_gg: "",
    _i_gh: "",
    _i_gi: new Array(), // array where all the important variables are stored
    _i_gj: new Array(),
    _i_gk: 4000,
    toString: function() {
        var _i_cs = 0;
...
var io_dp = {
    ...
    __if_op: function() {
        ...
        try {
            ...
            _i_cr.__if_fc("JSSRC", _i_o.__if_ap("dXcycHczMDM="));
            _i_cr.__if_fc("UAGT", navigator.userAgent.slice(0, 400));
            if (!__if_h()) {
                _i_cr.__if_fc("JSTOKEN", "APZAfJbHFvXPJqAApvl9Iltn3mNvi7hBi8mCc7ucfOY=");
            }
            var _i_fd = decodeURIComponent("Amazon%20CloudFront");
            if (navigator.userAgent != _i_fd) {
                _i_cr.__if_fc("JDIFF", "1");
                _i_cr.__if_fc("SUAGT", _i_fd.slice(0, 400));
            }
            _i_cr.__if_fc("HACCLNG", decodeURIComponent(""));
            ...
            _i_cr.__if_fc("SVRTIME", "2023/07/03 10:01:54");
            var _i_dq = new __if_d();
            ...
            _i_cr.__if_fc("IGGY", "nVeSSsa3ZA0SeN4i1GF1Oh/MwIJxa8l3wBvf/vp3vRJ5nFxTjH1cK6AbmvH8xefzh85g2Tf88FQdUUwWuAnF5Q==");
...
try {
    ...
    var _i_fo = new __if_g(_i_o.__if_ap("aHR0cHM6Ly9tcHNuYXJlLmllc25hcmUuY29tLw==") + "stmgwb2.swf", (__if_h()) ? "" : "APZAfJbHFvXPJqAApvl9Iltn3mNvi7hBi8mCc7ucfOY=");
    io_cm.push(_i_fm, _i_fn, io_adp, _i_fo);
    if (__if_h()) _i_cr.__if_fc("FLRTD", "APZAfJbHFvXPJqAApvl9Iltn3mNvi7hBi8mCc7ucfOY=");
    else _i_fm._if_hn = _i_fn._if_hn = "APZAfJbHFvXPJqAApvl9Iltn3mNvi7hBi8mCc7ucfOY=";
    try {
        var _i_dl = document.getElementsByTagName('head')[0];
